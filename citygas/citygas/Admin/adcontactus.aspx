<%@ Page Title="" Language="C#" MasterPageFile="~/adminms.Master" AutoEventWireup="true" CodeBehind="adcontactus.aspx.cs" Inherits="citygas.Admin.adcontactus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <section id="contact-info" style="border: thick solid #C0C0C0">
        ...
        <div class="gmap-area" style="background-image: url('http://localhost:2436/Admin/images/map.jpg')">
           <div class="row">
